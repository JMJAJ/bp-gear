      ...
      {/* <div className="px-4 py-3 border-b border-[#1a1a1a]">
        <div className="text-[9px] uppercase tracking-[1px] text-[#444] mb-2">
          <span
            ...
            data-tip="Add raw stats from talents, planetarium, account levels, etc."
          >
            Base Raw Stats
          </span>
        </div>
        <div className="grid grid-cols-2 gap-1.5">
          ...
          <NumberInput label="Agility*" value={base.agi}  onChange={v => setBase({agi:v})} tip="Agility converts to raw Haste at a 0.45 ratio." />
        </div>
      </div> */}
