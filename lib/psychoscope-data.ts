...
export const CLASS_FACTORS: ClassFactorSet[] = [
  ...
  },
  {
    ...
    factors: [
      { name: "Heavy Guardian X1",  icon: fi("yinzi_s2_09_001"), description: "In the Shield Bash status, All Element DMG +5.8%." },
      { name: "Heavy Guardian X2",  icon: fi("yinzi_s2_09_002"), description: "Shield Bash Dream DMG +30%." },
      { name: "Heavy Guardian X3",  icon: fi("yinzi_s2_09_003"), description: "Rage Burst, Terra Sunder from Lord of Rocks Dream DMG +15%." },
      { name: "Heavy Guardian X4",  icon: fi("yinzi_s2_09_004"), description: "Sandgrip charge count +1; Basic Attack Dream DMG +40%." },
      { name: "Heavy Guardian X5",  icon: fi("yinzi_s2_09_005"), description: "Each 1% Mastery grants 0.5% ATK." },
      { name: "Heavy Guardian X6",  icon: fi("yinzi_s2_09_006"), description: "In the Countercrush status, All Element DMG +5.8%." },
      { name: "Heavy Guardian X7",  icon: fi("yinzi_s2_09_007"), description: "Granite Fury, Stone Fist Dream DMG +21.4%." },
      { name: "Heavy Guardian X8",  icon: fi("yinzi_s2_09_008"), description: "After each successful Block, ATK +4.4% for 15s stacking up to 4 times." },
      { name: "Heavy Guardian X9",  icon: fi("yinzi_s2_09_009"), description: "After each successful Block, Max HP +4.4% for 15s stacking up to 4 times." },
      { name: "Heavy Guardian X10", icon: fi("yinzi_s2_09_010"), description: "Block Countercrush can trigger Lucky Strike; Block Countercrush Dream DMG +10%." },
      { name: "Heavy Guardian X11", icon: fi("yinzi_s2_09_011"), description: "When Stone Fist hits only one target, its damage and healing are doubled; Stone Fist Dream DMG +15%." },
    ],
    stasis: [
      { name: "Heavy Guardian Stasis X1", icon: fi("yinzi_s2_common_031"), description: "When taking Magic DMG, there is a fixed 10% chance to gain 35% MATK Reduction." },
      { name: "Heavy Guardian Stasis X2", icon: fi("yinzi_s2_common_032"), description: "Max HP +6.5%; for every 50 Rage consumed, restores 2% Max HP." },
    ],
  },
  {
    className: "Stormblade",
    factors: [
      { name: "Stormblade X1",  icon: fi("yinzi_s2_01_001"), description: "Iaido Slash Dream DMG +5%." },
      { name: "Stormblade X2",  icon: fi("yinzi_s2_01_002"), description: "Flash strike, Raijin Dash Dream DMG +7%." },
      { name: "Stormblade X3",  icon: fi("yinzi_s2_01_003"), description: "Dracoflash, Phantom Slash Dream DMG +10%." },
      { name: "Stormblade X4",  icon: fi("yinzi_s2_01_004"), description: "Thundercut Dream DMG +8.35%; increases the Cast Speed of Thundercut." },
      { name: "Stormblade X5",  icon: fi("yinzi_s2_01_005"), description: "Volt Surge charge count +1, but duration -4s; Ultimate Dream DMG +25%." },
      { name: "Stormblade X6",  icon: fi("yinzi_s2_01_006"), description: "Thundercut, Thundercleave Dream DMG +7%." },
      { name: "Stormblade X7",  icon: fi("yinzi_s2_01_007"), description: "Storm Scythe, Divine Sickle Dream DMG +8.5%." },
      { name: "Stormblade X8",  icon: fi("yinzi_s2_01_008"), description: "Moonblade Dream DMG +31.3%." },
      { name: "Stormblade X9",  icon: fi("yinzi_s2_01_009"), description: "Moonstrike attack count +3; Moonstrike Dream DMG +10%." },
      { name: "Stormblade X10", icon: fi("yinzi_s2_01_010"), description: "Stormflash duration +3.5s; Moonstrike, Thunderstrike Dream DMG +11.4%." },
      { name: "Stormblade X11", icon: fi("yinzi_s2_01_011"), description: "When Volt Surge is not active, gains 1 Thunder Sigil every 5s, and when Iaido Slash deals damage to the current target, there is a fixed 16.2% chance to trigger Piercing Slash." },
    ],
    stasis: [
      { name: "Stormblade Stasis X1", icon: fi("yinzi_s2_common_021"), description: "During Volt Surge and Stormflash, restores 8% Max HP per second." },
      { name: "Stormblade Stasis X2", icon: fi("yinzi_s2_common_022"), description: "True Sight charge count +1; CD -5s." },
    ],
  },
  {
    className: "Wind Knight",
    factors: [
      { name: "Wind Knight X1",  icon: fi("yinzi_s2_04_001"), description: "Valor Cyclone Dream DMG +10%." },
      { name: "Wind Knight X2",  icon: fi("yinzi_s2_04_002"), description: "Spiral Thrust, Breach Pursuit Dream DMG +70%." },
      { name: "Wind Knight X3",  icon: fi("yinzi_s2_04_003"), description: "Triggers Vortex Strike upon entering combat; Vortex Strike Dream DMG +10.9%." },
      { name: "Wind Knight X4",  icon: fi("yinzi_s2_04_004"), description: "Drake Cannon Dream DMG +43.8%." },
      { name: "Wind Knight X5",  icon: fi("yinzi_s2_04_005"), description: "Valor Cyclone can trigger Lucky Strike; Valor Cyclone Dream DMG +3%." },
      { name: "Wind Knight X6",  icon: fi("yinzi_s2_04_006"), description: "Galeform duration +4s." },
      { name: "Wind Knight X7",  icon: fi("yinzi_s2_04_007"), description: "Instant Edge Dream DMG +14% (does not affect Instant Edge Combo)." },
      { name: "Wind Knight X8",  icon: fi("yinzi_s2_04_008"), description: "Falcon Toss, Instant Edge Combo Dream DMG +19.4%." },
      { name: "Wind Knight X9",  icon: fi("yinzi_s2_04_009"), description: "Tornado from Tornado Dance can trigger Lucky Strike; Tornado from Tornado Dance Dream DMG +8.8%." },
      { name: "Wind Knight X10", icon: fi("yinzi_s2_04_010"), description: "Azure Sever from Sharp Long Breath always triggers Crit; Dream DMG of Azure Sever from Sharp Long Breath +19.4%." },
      { name: "Wind Knight X11", icon: fi("yinzi_s2_04_011"), description: "Sharp Impact gains 5% charge every 6.4s (affected by CD Boost); Dream DMG of Sharp Impact and Typhoon: Sharp Impact +9.2%." },
    ],
    stasis: [
      { name: "Wind Knight Stasis X1", icon: fi("yinzi_s2_common_023"), description: "Aegis Gale charge count +1; CD -5s." },
      { name: "Wind Knight Stasis X2", icon: fi("yinzi_s2_common_024"), description: "During Galeform, Dream Resistance +8%." },
    ],
  },
  {
    className: "Marksman",
    factors: [
      { name: "Marksman X1",  icon: fi("yinzi_s2_11_001"), description: "Storm Arrow Dream DMG +41%." },
      { name: "Marksman X2",  icon: fi("yinzi_s2_11_002"), description: "Wild Wolf - Tail Sweep Dream DMG +17.5%." },
      { name: "Marksman X3",  icon: fi("yinzi_s2_11_003"), description: "Wild Wolf - Bite Dream DMG +5.5%." },
      { name: "Marksman X4",  icon: fi("yinzi_s2_11_004"), description: "Lightseeker Arrow Dream DMG +35%; the Crit DMG of Lightseeker Arrow reaches 233%." },
      { name: "Marksman X5",  icon: fi("yinzi_s2_11_005"), description: "Dream DMG of Double Arrow and Quadraflare +19.4%." },
      { name: "Marksman X6",  icon: fi("yinzi_s2_11_006"), description: "Falcon Strike Dream DMG +14.1%." },
      { name: "Marksman X7",  icon: fi("yinzi_s2_11_007"), description: "Lightning Strike Dream DMG +32.4%." },
      { name: "Marksman X8",  icon: fi("yinzi_s2_11_008"), description: "During Torrent Volley, Focus duration is paused; Torrent Volley Dream DMG +14%." },
      { name: "Marksman X9",  icon: fi("yinzi_s2_11_009"), description: "Each 4% Haste increases Radiance Barrage hit count by 1; Radiance Barrage Dream DMG increases by 20.6%." },
      { name: "Marksman X10", icon: fi("yinzi_s2_11_010"), description: "For the next 10s after Blast Shot is cast, Falcon (Strike, Lightning Strike, Phantom Falcon) Dream DMG +14%." },
      { name: "Marksman X11", icon: fi("yinzi_s2_11_011"), description: "Powerdraw hit count +1 (total damage unchanged); Powerdraw Dream DMG +35%." },
    ],
    stasis: [
      { name: "Marksman Stasis X1", icon: fi("yinzi_s2_common_027"), description: "During Focus, Dream Resistance +15%." },
      { name: "Marksman Stasis X2", icon: fi("yinzi_s2_common_028"), description: "During Deter Shot, MATK Reduction +25%; Deter Shot CD -2.8s." },
    ],
  },
  {
    className: "Frost Mage",
    factors: [
      { name: "Frost Mage X1",  icon: fi("yinzi_s2_02_001"), description: "Frost Lance Dream DMG +7%." },
      { name: "Frost Mage X2",  icon: fi("yinzi_s2_02_002"), description: "Meteor Storm Dream DMG +16.7%." },
      { name: "Frost Mage X3",  icon: fi("yinzi_s2_02_003"), description: "Ice Arrow from Ice Revelation Dream DMG +21.1% (does not affect Frost Explosion)." },
      { name: "Frost Mage X4",  icon: fi("yinzi_s2_02_004"), description: "Glacial Spear from Icicle Volley, Frost Comet Dream DMG +35%." },
      { name: "Frost Mage X5",  icon: fi("yinzi_s2_02_005"), description: "Blizzard Dream DMG +70%; if only one target is hit, Dream DMG additionally +35%." },
      { name: "Frost Mage X6",  icon: fi("yinzi_s2_02_006"), description: "Frostbeam Dream DMG +9.7%." },
      { name: "Frost Mage X7",  icon: fi("yinzi_s2_02_007"), description: "While channeling Frostbeam, repeatedly tap the Tidepool skill to generate Tidepool at the current target spot; Tidepool Dream DMG +25%." },
      { name: "Frost Mage X8",  icon: fi("yinzi_s2_02_008"), description: "Against targets inside Blizzard, Ice Core from Ice Revelation's chance to trigger Ice Arrow +12%." },
      { name: "Frost Mage X9",  icon: fi("yinzi_s2_02_009"), description: "Frozen Gale Dream DMG +87.5%; for every 50 Ice Energy consumed in the past 15s, additionally +9.72%." },
      { name: "Frost Mage X10", icon: fi("yinzi_s2_02_010"), description: "In the Permafrost status, Lucky Strike Dream DMG +58.3%." },
      { name: "Frost Mage X11", icon: fi("yinzi_s2_02_011"), description: "Frost Lance deals an additional area hit against targets inside Blizzard. This hit deals 100% Blizzard DMG.." },
    ],
    stasis: [
      { name: "Frost Mage Stasis X1", icon: fi("yinzi_s2_common_025"), description: "All Element Resistance +15%; during Permafrost, Dream Resistance +15%." },
      { name: "Frost Mage Stasis X2", icon: fi("yinzi_s2_common_026"), description: "Frost Shelter charge count +1; CD -3.2s." },
    ],
  },
  {
    className: "Verdant Oracle",
    factors: [
      { name: "Verdant Oracle X1",  icon: fi("yinzi_s2_05_001"), description: "Wild Bloom, Stag Charge Dream DMG +31.3%." },
      { name: "Verdant Oracle X2",  icon: fi("yinzi_s2_05_002"), description: "Gains Super Armor when casting Infusion; Infusion Dream DMG +16.7%." },
      { name: "Verdant Oracle X3",  icon: fi("yinzi_s2_05_003"), description: "Regen Pulse becomes instant cast; Regen Pulse Dream DMG +18.5%." },
      { name: "Verdant Oracle X4",  icon: fi("yinzi_s2_05_004"), description: "When affected by Symbiotic Mark from Smite Spec, Magical Amp +5%." },
      { name: "Verdant Oracle X5",  icon: fi("yinzi_s2_05_005"), description: "Feral Seed drops one additional seed; Feral Seed Dream DMG +25%." },
      { name: "Verdant Oracle X6",  icon: fi("yinzi_s2_05_006"), description: "Nature Ward shield amount +50%, and for every 1% Luck or Crit, it gains an additional +1%. Nature Ward grants an additional 5% All Element Resistance for 8s." },
      { name: "Verdant Oracle X7",  icon: fi("yinzi_s2_05_007"), description: "Within 10s after casting Growth Arcane or Nature Ward, MATK +16.7%." },
      { name: "Verdant Oracle X8",  icon: fi("yinzi_s2_05_008"), description: "Casting Blossom Charge grants Super Armor for 5s; Blossom Charge Dream DMG +100%, Control duration +1.5s." },
      { name: "Verdant Oracle X9",  icon: fi("yinzi_s2_05_009"), description: "Wild Seed Dream DMG +50%; Nourishing Seed Healing +50% (from Regen Bud)." },
      { name: "Verdant Oracle X10", icon: fi("yinzi_s2_05_010"), description: "Grove Wish deals Magic DMG equal to 500% ATK." },
      { name: "Verdant Oracle X11", icon: fi("yinzi_s2_05_011"), description: "Lucky Strike Dream DMG +50%, but Symbiotic Mark converted healing is reduced by 32%." },
    ],
    stasis: [
      { name: "Verdant Oracle Stasis X1", icon: fi("yinzi_s2_common_033"), description: "Excess healing received is converted into a Shield lasting 10s, up to 18% Max HP." },
      { name: "Verdant Oracle Stasis X2", icon: fi("yinzi_s2_common_034"), description: "When casting Grove Wish or Infusion, Dream Resistance +12% for 5s." },
    ],
  },
  {
    className: "Beat Performer",
    factors: [
      { name: "Beat Performer X1",  icon: fi("yinzi_s2_13_001"), description: "Amplified Beat Dream DMG +70%." },
      { name: "Beat Performer X2",  icon: fi("yinzi_s2_13_002"), description: "Harmonic Anthem Dream DMG +35%." },
      { name: "Beat Performer X3",  icon: fi("yinzi_s2_13_003"), description: "Rhapsody of Flame Dream DMG +23.3%." },
      { name: "Beat Performer X4",  icon: fi("yinzi_s2_13_004"), description: "Magical Amp +6%; but Peaceful Tune converted healing is reduced by 32%." },
      { name: "Beat Performer X5",  icon: fi("yinzi_s2_13_005"), description: "Dream DMG of Passion Burst and Passion Fury +87.5%." },
      { name: "Beat Performer X6",  icon: fi("yinzi_s2_13_006"), description: "Encore Dream DMG triggered by yourself or teammates +23.3%." },
      { name: "Beat Performer X7",  icon: fi("yinzi_s2_13_007"), description: "Flame Note Dream DMG +17.5%." },
      { name: "Beat Performer X8",  icon: fi("yinzi_s2_13_008"), description: "In Healing Melody and Rhapsody of Flame status, All-Element Bonus +4.2%." },
      { name: "Beat Performer X9",  icon: fi("yinzi_s2_13_009"), description: "Healing Melody Healing +60%, but its performance energy cost +25%." },
      { name: "Beat Performer X10", icon: fi("yinzi_s2_13_010"), description: "When current HP is above 80%, Intellect +265; loses effect when HP is below 80%." },
      { name: "Beat Performer X11", icon: fi("yinzi_s2_13_011"), description: "When you cast Fivefold Crescendo, 65% of the overhealing will continuously recover over 10s." },
    ],
    stasis: [
      { name: "Beat Performer Stasis X1", icon: fi("yinzi_s2_common_035"), description: "During Heroic Melody and Healing Melody, Dream Resistance +10%." },
      { name: "Beat Performer Stasis X2", icon: fi("yinzi_s2_common_036"), description: "When healing yourself, Healing Output +5%." },
    ],
  },
]
